...
import { parentlinks } from "../../common/constants/navbars/navbar";
...
//   import IMAGES from './images';
  ...
  export default function Main({ supTitle, description, data }: FeaturesImagesProps) {
...
useEffect(() => {
  ...
  return (
    <>
      <NavigationProgress  />
      <DashboardLayout
        navbar={<NavbarLayout data={parentlinks} />}
        header={<></>}
      >
